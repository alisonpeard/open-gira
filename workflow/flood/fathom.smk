...
>>> snakemake --cores 6 -- results/direct_damages/somalia-latest_filter-{road-primary,road-secondary,road-tertiary,road-residential}/hazard-fathom-fluvial/EAD_and_cost_per_RP/slice-{0..63}.geoparquet
...
>>> snakemake --cores 6 -- results/direct_damages/somalia-latest_filter-{road-primary,road-secondary,road-tertiary,road-residential}/hazard-fathom-coastal/EAD_and_cost_per_RP/slice-{0..63}.geoparquet

To test run with one slice for fluvial:
>>> snakemake --cores 6 -- results/direct_damages/somalia-latest_filter-{road-primary,road-secondary,road-tertiary,road-residential}/hazard-fathom-fluvial/EAD_and_cost_per_RP/slice-{0..1}.geoparquet
"""
...
rule fathom_all:
    input:
        tiffs = expand(
            ...
            SCENARIO=["SSP2-4p5"],   # ["historical", "SSP2_4p5", "SSP5_8p5"]
